...
`;
 ...
 cmd({
   ...
   if (_0xb75e78.quoted && _0xb75e78.text) {
     ...
     if (_0x5b8ee5[0].includes("WASI-MD-V2 • sᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ")) {
     ...
     } else if (_0x5b8ee5[0].includes("WASI-MD-V2 • ʏᴏᴜᴛᴜʙᴇ ᴅᴏᴡɴʟᴏᴀᴅ")) {
     ...
     } else if (_0x5b8ee5[0].includes("WASI-MD-V2 • ᴀᴘᴋ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪsᴛ")) {
